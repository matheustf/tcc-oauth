package com.puc.tcc.oauth.advice;
...
import com.puc.tcc.oauth.dto.BaseDTO;
...
public class ExceptionAdvice {
	...
	public ResponseEntity<BaseDTO> processParameterizedValidationError(OAuthException ex) {
		log.error(ex.getMessage(),ex);
